...
public class EnumUtils {
	...
	/**
	 * 供 解析通用查询参数（分页参数、排序参数） DataGridUtils.parseQueryInfo方法调用
	 * 
	 * 根据类、字段名称、字段值（枚举字符），若字段为枚举，返回枚举值，否则直接返回字段值
	 * 
	 * @param entityCls
	 *            类，如com.linewell.ccip.servicesbase.bean.log.OrgLog.class
	 * @param fieldName
	 *            字段名称，如com.linewell.ccip.servicesbase.bean.log.type.OperType
	 * @param fieldVal
	 *            字段（枚举字符串），如INSERT
